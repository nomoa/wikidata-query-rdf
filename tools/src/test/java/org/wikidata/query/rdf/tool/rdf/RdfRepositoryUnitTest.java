...
public class RdfRepositoryUnitTest {
    ...
    public void testExtractValuesToCleanup() {
        ...
        List<String> existingValues = asList("val:maybe_orphan_1", "val:maybe_orphan_2", "val:quantity_to_keep", "val:date_to_keep", "val:coord_to_keep");
        assertThat(RdfRepository.extractValuesToCleanup(existingValues, statements)).containsExactlyInAnyOrder("val:maybe_orphan_1", "val:maybe_orphan_2");
    }
    ...
    public void testExtractReferencesToCleanup() {
        ...
        List<String> existingRefs = asList("ref:maybe_orphan_1", "ref:maybe_orphan_2", "ref:to_keep");
